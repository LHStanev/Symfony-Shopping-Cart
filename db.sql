...
INSERT INTO `books` (`id`, `genre_id`, `name`, `description`, `author`, `price`, `quantity`, `image`, `year`) VALUES
	...
	(4, 2, 'To Kill a Mockinbird', 'The unforgettable novel of a childhood in a sleepy Southern town and the crisis of conscience that rocked it, To Kill A Mockingbird became both an instant bestseller and a critical success when it was first published in 1960. It went on to win the Pulitzer Prize in 1961 and was later made into an Academy Award-winning film, also a classic.', 'Harper Lee', 11.50, 6, '4.jpg', 1961),
	...
	(15, 6, 'A Game of Thrones', 'As Warden of the north, Lord Eddard Stark counts it a curse when King Robert bestows on him the office of the Hand. His honour weighs him down at court where a true man does what he will, not what he must … and a dead enemy is a thing of beauty.\r\n\r\nThe old gods have no power in the south, Stark’s family is split and there is treachery at court. Worse, the vengeance-mad heir of the deposed Dragon King has grown to maturity in exile in the Free Cities. He claims the Iron Throne.', 'George R.R. Martin', 23.00, 7, '15.jpg', 2005),
...
-- Дъмп данни за таблица symfony3.genres: ~12 rows (approximately)
...
-- Дъмп данни за таблица symfony3.promotions: ~2 rows (approximately)
/*!40000 ALTER TABLE `promotions` DISABLE KEYS */;
INSERT INTO `promotions` (`id`, `genre_id`, `discount`, `startDate`, `endDate`) VALUES
	(1, 6, 50, '2017-12-21', '2017-12-25'),
	(2, 7, 20, '2017-12-01', '2017-12-20');
...
-- Дъмп данни за таблица symfony3.reviews: ~7 rows (approximately)
...
INSERT INTO `reviews` (`id`, `book_id`, `user_id`, `body`, `createdOn`) VALUES
	...
	(8, 16, 21, 'Very Interesting!', '2017-12-22 10:09:17');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `initial_cash` decimal(11,2) NOT NULL,
  `spent_money` decimal(11,2) NOT NULL,
...
-- Дъмп данни за таблица symfony3.users: ~8 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `username`, `email`, `password`, `initial_cash`, `spent_money`, `is_enabled`) VALUES
	(21, 'lazar_admin', 'lazar@stanev.com', '$2y$13$IiRB4.kNSmwiFf3WFuVYSOV0YWbdLMVIFUcPvoHSZXiDYT45a4NOC', 120.00, 0.00, 1),
	(23, 'Barry', 'barry@white.com', '$2y$13$3cveOR2jydKnH4RVtx1wg.q4BAA5bbtYcnfL6/YolKGjaSOHBmdxC', 0.00, 0.00, 1),
	(24, 'Marry', 'maria88@abv.bg', '$2y$13$0i.PM9m2xv1P14/mggrVouu6CexClW4uvM3BDpC7n/PXKTmkk.kje', 230.00, 120.00, 1),
	(25, 'Larry', 'larry@page.com', '$2y$13$nIiKtZa8qjX99omJCddGNOriYOc0nw1mQQS8t3NeJZv3.ADDGeR2K', 500.00, 275.00, 1),
	(26, 'anonymous', 'anonymous@anonymous.com', 'no_password', 0.00, 0.00, 1),
	(27, 'Garry', 'garry@lineker.com', '$2y$13$7Ts1P8jlqr/5UpmbtrUBQe3q82F6MlvmcFbS1.SHSc1mcbeTyXCd6', 600.00, 89.00, 1),
	(28, 'Sally', 'sally@specter.com', '$2y$13$.bQ7fLu0qoQ7Nn7S/6m.zekpR0Pi3JNu4iuwnsbd5ZuZqW5wQKORW', 100.00, 0.00, 1),
	(29, 'Jim', 'Jim@carey.com', '$2y$13$6RJ3xh7CcJvJY7xNuGvHL.RwYR8mN/wUSscQFhTlJBL/rEZc5ML86', 500.00, 28.00, 0);
...
-- Дъмп данни за таблица symfony3.user_purchases: ~10 rows (approximately)
...
-- Дъмп данни за таблица symfony3.user_roles: ~7 rows (approximately)
